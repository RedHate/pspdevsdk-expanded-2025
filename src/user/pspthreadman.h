 ...
 * @param attr - The LwMutex attributes, zero or more of ::SceLwMutexAttributes.
 ...
 */
SceDebugProfilerRegs *sceKernelReferThreadProfiler(void);

/**
 * Get the globile profiler registers.
 * @return Pointer to the registers, NULL on error
 */
SceDebugProfilerRegs *sceKernelReferGlobalProfiler(void);
