...
typedef int	PspKernelSysMemAlloc_t;

#define SCE_KERNEL_UNKNOWN_PARTITION			((SceUID)0)
#define SCE_KERNEL_PRIMARY_KERNEL_PARTITION		((SceUID)1)					/*default kernel partition           */
#define SCE_KERNEL_PRIMARY_USER_PARTITION		((SceUID)2)					/*default user partition             */
