...
typedef void (*SceDebugPutChar)(unsigned short* args, unsigned int ch);
 ...
 */
void sceKernelRegisterDebugPutchar(SceDebugPutChar func);
 ...
 */
SceDebugPutChar sceKernelGetDebugPutchar(void);
