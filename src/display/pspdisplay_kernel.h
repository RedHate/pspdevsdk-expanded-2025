 ...
 * @param pixelformat - One of ::sceDisplayPixelFormats.
 * @param sync - One of ::sceDisplaySetBufSync
 *
 * @return 0 on success
 */
 ...
 * @param pixelformat 	- pointer to int to receive one of ::sceDisplayPixelFormats.
 * @param sync 			- pointer to int to receive one of ::sceDisplaySetBufSync
 *
 * @return 0 on success
 */
