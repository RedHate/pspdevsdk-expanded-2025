...
#define SCE_ATRAC_SUCCESS                       SCE_OK
...
#define SCE_ATRAC_ERROR_NOT_4BYTE_ALIGNMENT     (0x80630014)
...
#define SCE_ATRAC_ALLDATA_IS_ON_MEMORY             (-1)
#define SCE_ATRAC_NONLOOP_STREAM_DATA_IS_ON_MEMORY (-2)
#define SCE_ATRAC_LOOP_STREAM_DATA_IS_ON_MEMORY    (-3)
...
int sceAtracGetBufferInfoForReseting(int atracID, u32 uiSample, SceBufferInfo *pBufferInfo);
