...
int sceRtcSetYear(ScePspDateTime *pTime, int year);
int sceRtcSetMonth(ScePspDateTime *pTime, int month);
int sceRtcSetDay(ScePspDateTime *pTime, int day);
int sceRtcSetHour(ScePspDateTime *pTime, int hour);
int sceRtcSetMinute(ScePspDateTime *pTime, int minute);
int sceRtcSetSecond(ScePspDateTime *pTime, int second);
int sceRtcSetMicrosecond(ScePspDateTime *pTime, int microsecond);

int sceRtcGetYear(const ScePspDateTime *pTime);
int sceRtcGetMonth(const ScePspDateTime *pTime);
int sceRtcGetDay(const ScePspDateTime *pTime);
int sceRtcGetHour(const ScePspDateTime *pTime);
int sceRtcGetMinute(const ScePspDateTime *pTime);
int sceRtcGetSecond(const ScePspDateTime *pTime);
int sceRtcGetMicrosecond(const ScePspDateTime *pTime);
